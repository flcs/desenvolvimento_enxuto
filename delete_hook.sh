...
#++ curl -X POST -u flcs:xxxxx -i https://api.github.com/repos/flcs/desenvolvimento_enxuto/hooks -d '{ "name": "web", "active": true, "config": { "url": "http://flcs.homeunix.com:8080/webhook/desenvolvimento_enxuto" } } '
